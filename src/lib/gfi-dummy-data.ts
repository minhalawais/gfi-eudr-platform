...
export const scenarioOptions: ScenarioOption[] = [
  ...
  },
  {
    ...
    summary: "JB Cocoa and Indococoa have provided acceptable provenance and CoC evidence.",
...
export const suppliers: SupplierRecord[] = [
  ...
  },
  {
    ...
    name: "Indococoa",
    country: "Indonesia",
    supplierType: "Processor / Newly disclosed supplier",
    tier: 1,
    commodities: ["COCOA"],
    onboardingStatus: "PENDING_RESPONSE",
    declarationStatus: "MISSING",
    cocStatus: "MISSING",
    geolocationCoverage: 0,
    contractStatus: "MISSING",
    latestRiskLevel: "CRITICAL",
    facilities: ["East Java alkalized cocoa production line"],
    certifications: [],
    evidenceCount: 1,
    issues: [
      "Supplier was discovered on-site and was not present in the original GFI submission.",
      "No declaration, no contract clause, and no geolocation evidence have been provided yet.",
      "Any cocoa flow using this supplier must remain blocked.",
    ],
    nextAction: "Issue formal supplier package immediately and block linked cocoa exports until response is received and reviewed.",
...
export const products: ProductRecord[] = [
  {
    ...
    ingredients: [
      ...
      toIngredient("ing-chew-citric", "Acidity Regulator (Citric Acid)", "291814", "2.20%"),
  ...
  },
  {
    ...
    ingredients: [
      toIngredient("ing-bubble-sugar", "Sugar", "170199", "64%"),
      ...
      toIngredient("ing-bubble-citric", "Acidity Regulator (Citric Acid)", "291814", "0.84%"),
  ...
  },
  {
    ...
    ingredients: [
      ...
      toIngredient("ing-hard-citric", "Acidity Regulator (Citric Acid)", "291814", "7.60%"),
      toIngredient("ing-hard-dextrose", "Dextrose (Glucose Powder)", "170230", "5.19%"),
      toIngredient("ing-hard-malic", "Malic Acid", "291819", "0.40%"),
      toIngredient("ing-hard-maltodextrin", "Maltodextrin", "170290", "0.10%"),
  ...
  },
  {
    ...
    ingredients: [
      ...
      toIngredient("ing-choc-cocoa-alkalized", "Alkalized cocoa powder", "180500", "2.00%", {
        supplierIds: ["sup-indococoa"],
        readiness: "BLOCKED",
        evidenceStatus: "MISSING",
        blockingReason: "Undisclosed supplier discovered on-site with no completed onboarding.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      toIngredient("ing-waf-palm", "Vegetable fat", "151329 review path", "18.60%", {
        supplierIds: ["sup-cargill"],
        readiness: "REVIEW_REQUIRED",
        evidenceStatus: "PARTIAL",
      ...
      toIngredient("ing-waf-cocoa", "Cocoa powder", "180500", "5.85%", {
        supplierIds: ["sup-jb-cocoa"],
        readiness: "BLOCKED",
        evidenceStatus: "MISSING",
        blockingReason: "Cocoa provenance must be completed before future EU export planning can continue.",
        supplyChainStatus: "GAPS_FOUND",
      }),
...
export const traceabilityCases: TraceabilityCase[] = [
  ...
  },
  {
    ...
    chainOfCustodySummary: "Future chocolate shipment depends on JB Cocoa and Indococoa provenance packs that are not complete.",
    ...
    gaps: [
      ...
      "Undisclosed supplier Indococoa remains unresolved.",
    ],
  },
  {
    id: "trace-forward-indococoa",
    mode: "FORWARD",
    rootReference: "LOT-INDOCOCOA-HPA01",
    completeness: "INCOMPLETE",
    chainOfCustodySummary: "Forward trace from Indococoa lot shows impacted product planning but no releasable shipment.",
    supersession: "Forward trace snapshot v2.",
    nodes: [
      {
        label: "Goods receipt INDO-GRN-002",
        entityType: "GOODS_RECEIPT",
        status: "WARNING",
  ...
  },
  {
    ...
    issues: [
      ...
      },
      {
        ...
        blocking: true,
        message: "Indococoa is not fully onboarded and remains an undisclosed supplier blocker.",
      },
      {
...
export const outputPackages: OutputPackageRecord[] = [
  ...
  },
  {
    ...
    supersessionNote: "New snapshot preserved after Indococoa discovery, but package remains blocked.",
...
export const documents: DocumentRecord[] = [
  ...
  },
  {
    ...
    title: "Indococoa onboarding and declaration pack",
    documentRole: "SUPPLIER_REQUEST",
    linkedEntity: "Indococoa",
    status: "CURRENT",
    note: "Initial outreach opened after on-site discovery.",
  },
  {
...
export const concerns: ConcernRecord[] = [
  {
    id: "concern-001",
    headline: "Undisclosed cocoa supplier discovered during on-site review",
...
export const integrationOverview: IntegrationOverview = {
  ...
  reconciliationWarnings: [
    ...
    "Indococoa source linkage was added manually after on-site discovery, not from ERP.",
  ],
};
...
export const supplierPortalRequests: SupplierPortalRequest[] = [
  ...
  },
  {
    ...
    latestReviewerNote:
      "Supplier was discovered during site review and has not yet submitted the initial package.",
  },
];
...
export const eudrFormRequests: EudrFormRequest[] = [
  ...
  },
  {
    ...
    tokenLabel: "PORTAL-INDOCOCOA-2026-05",
    targetSupplierId: "sup-indococoa",
    targetNodeId: "node-choc-alkalized-indococoa",
    formType: "INTERMEDIARY",
    requestedBy: "GFI Compliance",
    requestedAt: "2026-05-21",
...
export function getScenarioData(scenarioId: string) {
  ...
  if (scenarioId === "after_cocoa_remediation") {
    ...
    // 2. Indococoa is Approved, risk level low, 100% geolocation, issues cleared
    const indo = currentSuppliers.find(s => s.id === "sup-indococoa");
    if (indo) {
      indo.onboardingStatus = "APPROVED";
      indo.declarationStatus = "SIGNED";
      indo.cocStatus = "VERIFIED";
      indo.geolocationCoverage = 100;
      indo.contractStatus = "EUDR_CLAUSE_PRESENT";
      indo.latestRiskLevel = "LOW";
      indo.issues = [];
      indo.nextAction = "Monitor compliance periodically.";
    }
    ...
    currentOutputPackages.forEach(pkg => {
      pkg.mode = "DIRECT_DDS";
    });
  }
